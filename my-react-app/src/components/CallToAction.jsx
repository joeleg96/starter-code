...
export default function CallToAction({selectPage}) {
    return <section className='mt-10'>
        <div className='w-[95%] mx-auto bg-[#E0E6E3] rounded-xl p-10 relative md:py-20 z-0'>
            <div>
                ...
                <div className='flex justify-center mt-8 w-44 mx-auto'>
                    <Button onClick={()=>{selectPage('Recipes'), window.scrollTo({ top: 0, behavior: "smooth" })}}>Browse recipes</Button> 
                </div>
